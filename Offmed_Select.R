...
library(MASS)
#To flag the visit PD patients start medication, once PD patients start medication, the measurement
# will be considered as NA. No subtype change(compared to previous version of select_off_med)
...
write.csv(x=PPMI_offmed2,file="/Users/qingfenghu/Documents/Research/Parkinson0215/Offmedfull2.csv",row.names=F)

#statistics about offmed 
length(IdList) #number of patients who do not have med information
